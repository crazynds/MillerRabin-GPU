/* ─────────────────────────────────────────────────────────────────────────────
 * FILE   src/ntt/kernels/inverse_core_transposed.cuh
 * ROLE   InverseCore__Fused — transposed variant for n_power >= 25
 *
 * HOW    Same as InverseCore_Fused with the block layout transposed, which
 *        is what the launch table selects for the largest transforms.
 *
 * CHANGELOG
